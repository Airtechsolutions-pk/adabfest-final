...
import 'provider/msg_cnfr_chair_app_provider.dart';
import 'package:flutter_html/src/style.dart' as styleshtml;

class MsgfromConfrChair extends StatefulWidget {
  const MsgfromConfrChair({Key? key}) : super(key: key);

  @override
  MsgfromConfrChairState createState() => MsgfromConfrChairState();

  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => MsgFromCnfrChairProvider(), child: MsgfromConfrChair());
  }
}

class MsgfromConfrChairState extends State<MsgfromConfrChair> {
  @override
  void initState() {
        ...
        child: SizedBox(
          ...
          child: Column(
            children: [
              ...
              //     children: [
              //       SizedBox(height: 8.v),
              //       args.chairConference.imgConChair.isNotEmpty ?    Center(
              //         child: Container(
              //           width: 120,
              //           height: 120,
              ...
              //               image: NetworkImage('${args.chairConference.imgConChair}'),
              //               fit: BoxFit.cover,
              //             ),
              //           ),
              //         ),
              ...
              //                   child:  Html(
              //                     data: args.chairConference.msgConferenceChair != ''
              //                         ? '${args.chairConference.msgConferenceChair}'
              //                         : 'Not Available',
              //                     style: {
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context) {
    return CustomAppBar(
      ...
      centerTitle: true,
      title: Text("Message From Conference Chairmen",style: TextStyle(
        color: Colors.white,
        fontSize: 20.fSize,
